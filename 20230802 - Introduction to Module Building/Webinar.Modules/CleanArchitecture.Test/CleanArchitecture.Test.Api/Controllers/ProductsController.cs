...
using CleanArchitecture.Test.Api.Controllers.ResponseTypes;
using CleanArchitecture.Test.Application.Products;
using CleanArchitecture.Test.Application.Products.CreateProduct;
using CleanArchitecture.Test.Application.Products.DeleteProduct;
using CleanArchitecture.Test.Application.Products.GetProductById;
using CleanArchitecture.Test.Application.Products.GetProducts;
using CleanArchitecture.Test.Application.Products.UpdateProduct;
...
namespace CleanArchitecture.Test.Api.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        /// <response code="400">One or more validation errors have occurred.</response>
        /// <response code="404">Can't find an ProductDto with the parameters provided.</response>
