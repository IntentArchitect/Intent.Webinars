...
namespace Webinar.Demo.Ordering.Application.EventHandlers.Orders
{
    ...
    public class OrderShipedDomainEventHandler : INotificationHandler<DomainEventNotification<OrderShipedDomainEvent>>
    {
        ...
        {
            _eventBus.Publish(new OrderShippedEvent
            {
                OrderId = notification.DomainEvent.Order.Id,
                DeliveryAddressLine1 = notification.DomainEvent.Order.Customer.DeliveryAddress.Line1,
                DeliveryAddressLine2 = notification.DomainEvent.Order.Customer.DeliveryAddress.Line2,
                DeliveryAddressCity = notification.DomainEvent.Order.Customer.DeliveryAddress.City,
                DeliveryAddressPostal = notification.DomainEvent.Order.Customer.DeliveryAddress.Postal
            });
        }
    }
}