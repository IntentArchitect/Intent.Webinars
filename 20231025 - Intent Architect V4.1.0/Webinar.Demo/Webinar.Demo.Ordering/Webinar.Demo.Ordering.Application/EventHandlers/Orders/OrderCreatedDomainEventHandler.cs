...
namespace Webinar.Demo.Ordering.Application.EventHandlers.Orders
{
    ...
    public class OrderCreatedDomainEventHandler : INotificationHandler<DomainEventNotification<OrderCreatedDomainEvent>>
    {
        ...
        {
            _eventBus.Publish(new OrderStartedEvent
            {
                Id = notification.DomainEvent.Order.Id,
                OrderDate = notification.DomainEvent.Order.OrderDate,
                CustomerId = notification.DomainEvent.Order.CustomerId
            });
        }
    }
}