...
using Webinar.Demo.Ordering.Application.Customers;
using Webinar.Demo.Ordering.Application.Customers.ChangeDeliveryAddressCustomer;
using Webinar.Demo.Ordering.Application.Customers.CreateCustomer;
using Webinar.Demo.Ordering.Application.Customers.DeleteCustomer;
using Webinar.Demo.Ordering.Application.Customers.GetCustomerById;
using Webinar.Demo.Ordering.Application.Customers.GetCustomers;
using Webinar.Demo.Ordering.Application.Customers.UpdateCustomer;
...
namespace Webinar.Demo.Ordering.Api.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        [HttpPut("api/customer/{id}/change-delivery-address")]
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult> ChangeDeliveryAddressCustomer(
            [FromRoute] Guid id,
            [FromBody] ChangeDeliveryAddressCustomerCommand command,
